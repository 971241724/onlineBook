...
<c:if test="${sessionScope.User == null }">
	<c:redirect url="login_manager.jsp"></c:redirect>
</c:if>
...
<ul class="nav">
<li  class="active"><a href="${pageContext.request.contextPath }/fruit_page/index.jsp"><i class="icon-black icon-home"></i>首页</a></li>
<li><a href="backstage.jsp?id=1"><i class="icon-flag"></i> 操作说明</a></li>
<li><a href="${pageContext.request.contextPath }/backstage/login_manager.jsp"><i class="icon-ok"></i>登陆</a></li>
...
<img src="${pageContext.request.contextPath }/backstage_img/first.png"/>

...
<head>
	...
	<script src="js/productslistsale.js"></script>
</head>
<%
...
<body data-last="<s:property value="#session.isLast"/>" data-keyword="<s:property value="keyWord"/>" data-hotLast="<s:property value="#session.hotisLast"/>" >
</s:if>
<s:else>
<body data-keyword="<s:property value="keyWord"/>" data-hotlast="<s:property value="#session.hotisLast"/>" data-user="<%=userId.toString()%>" >
</s:else>
				...
				<s:else>
					...
					<div class="products-sort">
						...
						<s:if test='order=="default"'>
								...
								<a class="hassaled " href="findSaleVegetables?keyWord=<s:property value="keyWord"/>&order=vegetableSaleCount&sort=desc&from=0" >销量<span>&nbsp;&nbsp;</span></a>
								<a class="price-up" href="findSaleVegetables?keyWord=<s:property value="keyWord"/>&order=vegetablePrice&sort=asc&from=0">价格<span>&nbsp;&nbsp;</span></a>
								<a class="last price-down"  href="findSaleVegetables?keyWord=<s:property value="keyWord"/>&order=vegetablePrice&sort=desc&from=0">价格<span>&nbsp;&nbsp;</span></a>
							...
							<a class="first  hot" href="findSaleVegetables?order=default&sort=desc&from=0">全部</a>

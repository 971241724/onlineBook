...
<body>
	<div class="main">
		<table class="table table-bordered">
			...
			<tr>
				<td>
				<form action="${pageContext.request.contextPath }/htupdateNotice.action" method="post" class="form-horizontal">
				...
				标题： <input type="text" name="notice_title" class="input-large"
						 ...
						 <br/><br/>
				内容：
						<textarea name="notice_content" class="textarea" rows="6">${notice.notice_content}</textarea>
				<br/><br/>

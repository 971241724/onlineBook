...
<head>
	...
	<!-- 本页面加载文件 -->
	<link rel="stylesheet" href="css/produ${pageContext.request.contextPath }/fruit_page_css/ctslist.css">
	<script src="${pageContext.request.contextPath }/fruit_page_js/productslist.js"></script>
</head>
		...
		<%-- <div id="content" class="wrapper1">
			<ul id="products-class">
				<li class="products-class-box first">
					<a href="#" class="products-class-img"><img src="${pageContext.request.contextPath }/fruit_page_img/bigclass1.jpg" alt=""></a>
				...
				<li class="products-class-box">
					<a href="#" class="products-class-img"><img src="${pageContext.request.contextPath }/fruit_page_img//bigclass2.jpg" alt=""></a>
					<div class="products-class-hot">
						<em>热门</em> |&nbsp;
						<s:action name="findHotKeysRefParam" id="findHotKeyWordsRefParam">
							<s:param name="param" value="'水果'"></s:param>
				...
				<li class="products-class-box">
					<a href="#" class="products-class-img"><img src="${pageContext.request.contextPath }/fruit_page_img/bigclass3.jpg" alt=""></a>
					<div class="products-class-hot">
						<em>热门</em> |&nbsp;
						<s:action name="findHotKeysRefParam" id="findHotKeyWordsRefParam">
				...
				<li class="products-class-box">
					<a href="#" class="products-class-img"><img src="${pageContext.request.contextPath }/fruit_page_img/bigclass4.jpg" alt=""></a>
					<div class="products-class-hot">
						<em>热门</em> |&nbsp;
						<s:action name="findHotKeysRefParam" id="findHotKeyWordsRefParam">
							<s:param name="param" value="'蔬菜'"></s:param>
			...
			<div class="slider-ad">
				<ul class="slider">
					...
					<li>
						<a href="#"><img src="<s:property value="#getAdById7.ad.advertisementPicAddr"/>" alt="<s:property value="#getAdById7.ad.advertisementTitle"/>"></a>
					</li>
					<li>
				...
				<s:else>
					...
					<div class="products-sort">
						...
						<s:if test='order=="default"'>
								...
								<a class="hassaled " href="findVegetableByKeyWord?keyWord=<s:property value="keyWord"/>&order=vegetableSaleCount&sort=desc&from=0" >销量<span>&nbsp;&nbsp;</span></a>
								<a class="price-up" href="findVegetableByKeyWord?keyWord=<s:property value="keyWord"/>&order=vegetablePrice&sort=asc&from=0">价格<span>&nbsp;&nbsp;</span></a>
								<a class="last price-down"  href="findVegetableByKeyWord?keyWord=<s:property value="keyWord"/>&order=vegetablePrice&sort=desc&from=0">价格<span>&nbsp;&nbsp;</span></a>
							...
							<a class="first  hot" href="findVegetableByKeyWord?order=default&sort=desc&from=0">全部</a>

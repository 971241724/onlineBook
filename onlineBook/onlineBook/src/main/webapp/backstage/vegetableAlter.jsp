...
<div class="main">
    <table class="table table-bordered">
        ...
        <tr>
             <td><form action="${pageContext.request.contextPath}/bookAlter.action" method="post" class="form-horizontal" onsubmit="return func()">
             <input type="hidden" name="book_id" value="${book.book_id }">
                    名称：
		     <input type="text" id="b_name" name="book_name" class="input-small" value="${book.book_name }"/>
		                 &nbsp;&nbsp;&nbsp;&nbsp;    价格：

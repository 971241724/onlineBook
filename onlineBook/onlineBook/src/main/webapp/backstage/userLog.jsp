...
<body>
	<div class="main">
		<label class="label">日志操作
		    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<a href="${pageContext.request.contextPath }/excelOutput.action"><button>导出Excel</button></a>
			&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<a href="${pageContext.request.contextPath }/excelOutputMoBan.action"><button>导出Excel模板</button></a>
		    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
			<a href="${pageContext.request.contextPath }/excelOutputMoBanX.action"><button>导出Excel2007模板</button></a>
		</label>

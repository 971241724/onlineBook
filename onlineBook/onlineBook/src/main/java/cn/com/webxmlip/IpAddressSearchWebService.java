 ...
 * 
 */
@WebServiceClient(name = "IpAddressSearchWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/C:/IpAddressSearchWebService.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/IpAddressSearchWebService.xml");
